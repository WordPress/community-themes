...
<!-- wp:image {"id":127,"sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|black-pink"}},"className":"is-style-blue-note-thin-stripes"} -->
<figure class="wp-block-image size-full is-style-blue-note-thin-stripes"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Ethel-Waters.jpg" alt="" class="wp-image-127"/></figure>
<!-- /wp:image -->