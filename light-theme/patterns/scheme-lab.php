...
<main class="wp-block-group alignfull scheme-lab has-contrast-color has-base-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large)">
	...
	<div class="wp-block-group alignwide">
		...
		<p class="has-contrast-color has-fixed-accent-background-color has-text-color has-background has-small-font-size" style="border-radius:999px;padding-top:0.35rem;padding-right:0.75rem;padding-bottom:0.35rem;padding-left:0.75rem"><?php echo esc_html__( 'Light-first · inline overrides', 'light-theme' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<div class="scheme-lab__switcher" role="group" aria-label="<?php echo esc_attr__( 'Preview color scheme', 'light-theme' ); ?>">
			...
			<button type="button" data-scheme-choice="light" aria-pressed="false"><?php echo esc_html__( 'Light', 'light-theme' ); ?></button>
			<button type="button" data-scheme-choice="dark" aria-pressed="false"><?php echo esc_html__( 'Dark', 'light-theme' ); ?></button>
		</div>
		<!-- /wp:html -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group alignwide" style="margin-top:var(--wp--preset--spacing--large);margin-bottom:var(--wp--preset--spacing--large)">
		...
		<h1 class="wp-block-heading has-xx-large-font-size"><?php echo esc_html__( 'One design, two signals.', 'light-theme' ); ?></h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"fontSize":"large"} -->
		<p class="has-large-font-size"><?php echo esc_html__( 'Every surface below uses a theme preset. Change the switch above—or your operating system appearance—and watch palette, gradient, and duotone values travel together.', 'light-theme' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group scheme-lab__card has-base-color has-primary-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)">
				...
				<h2 class="wp-block-heading has-base-color has-text-color"><?php echo esc_html__( 'Palette preset', 'light-theme' ); ?></h2>
				<!-- /wp:heading -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Primary, base, and contrast are matched by slug.', 'light-theme' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group scheme-lab__card has-contrast-color has-signal-gradient-background has-text-color has-background" style="padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)">
				<!-- wp:heading {"level":2} -->
				<h2 class="wp-block-heading"><?php echo esc_html__( 'Gradient preset', 'light-theme' ); ?></h2>
				<!-- /wp:heading -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'The same custom property points to a different gradient.', 'light-theme' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
	...
	<p class="has-text-align-center has-secondary-color has-text-color has-small-font-size"><?php echo esc_html__( 'The gold “Fixed accent” badge has no scheme override and should remain unchanged.', 'light-theme' ); ?></p>
	<!-- /wp:paragraph -->
</main>
<!-- /wp:group -->
